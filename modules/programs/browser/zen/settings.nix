...
in
{
  ...
  # Keep pages/tabs loaded (avoid discard/lazy restore)
  "browser.tabs.unloadOnLowMemory" = lock-false;
  "browser.tabs.min_inactive_duration_before_unload" = {
    Value = 31536000000; # 1 year in ms
    Status = "locked";
  };
  "browser.sessionhistory.max_total_viewers" = {
    Value = -1; # enable BFCache heuristics
    Status = "locked";
  };
  "browser.sessionstore.restore_on_demand" = lock-false;
  "browser.sessionstore.restore_pinned_tabs_on_demand" = lock-false;
