  ...
  home-manager.sharedModules = [
    (_: {
      ...
      programs.zsh = {
        ...
        shellAliases = {
          cls = "clear";
          cnlss = "sudo mount -t cifs //itf-rs-store24.hpc.uiowa.edu/vosslabhpc /mnt/lss -o credentials=/etc/lss-creds,uid=$(id -u),gif=$(id -g),file_mode=0644,dir_mode=0755,noperm";
