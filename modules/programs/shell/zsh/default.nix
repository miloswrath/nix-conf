    ...
    ({config, ...}: {
      ...
      programs.zsh = {
        ...
        shellAliases = {
          ...
          cnrdss = "sudo mount -t cifs //rdss.iowa.uiowa.edu/rdss_mwvoss /mnt/rdss \ -o vers=3.1.1,sec=krb5,cruid=1000,uid=1000,gid=100";
